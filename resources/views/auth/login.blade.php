...
<form method="Post" class=" bg-blue-100 rounded-xl mt-24 p-6" action="{{ route('login.user')}}">
    @csrf
    ...
    <div class="w-full">
    <button type="submit" class="text-white font-medium w-full bg-blue-800 rounded-lg cursor-pointer hover:bg-blue-600 py-3 mt-3">Login</button>
    </div>
